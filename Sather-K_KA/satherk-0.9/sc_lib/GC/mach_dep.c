...
# if !defined(VAX) && !defined(M68K_SUN) && !defined(M68K_HP)&& !defined(SPARC) && !defined(I386) && !defined(NS32K) && !defined(SCO)
...
#       ifdef SCO
	/* SCO code, generic code does not appear to work */
	  asm("pushl %eax");  asm("call tl_mark"); asm("addl $4,%esp");
	  asm("pushl %ecx");  asm("call tl_mark"); asm("addl $4,%esp");
	  asm("pushl %edx");  asm("call tl_mark"); asm("addl $4,%esp");
	  asm("pushl %esi");  asm("call tl_mark"); asm("addl $4,%esp");
	  asm("pushl %edi");  asm("call tl_mark"); asm("addl $4,%esp");
	  asm("pushl %ebx");  asm("call tl_mark"); asm("addl $4,%esp");
#       endif
...
#     endif
      ...
      /* other machines... */
#       if !(defined M68K_SUN) && !defined(M68K_HP) && !(defined VAX) && !(defined RT) && !(defined SPARC) && !(defined I386) &&!(defined NS32K) && !defined(SCO)
	    --> bad news <--
#       endif
}
